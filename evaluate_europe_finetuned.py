...
MODEL_PATH = "./finbert_europe_finetuned"
...
total_correct = 0
total_samples = 0
print("\nEvaluating region: Europe (Fine-tuned Model)")

for company in os.listdir(EUROPE_FOLDER):
    company_folder = os.path.join(EUROPE_FOLDER, company)
...
print(f"\nRegion Summary: Europe (Fine-tuned)\n   Accuracy: {region_acc:.4f}\n   Total Samples: {total_samples}\n   Correct: {total_correct}")
